      ...
      try {
        ...
        if (rows[0].salt === null || rows[0].password === null) {
          ...
          return done(null, false, {
            message:
              "You signed up using an external account. Please either login using your social media account, or you can create a password by clicking forgot password below.",
          });
        }
